...
class Privacy extends StatelessWidget {
  ...
  final String htmlData = r""" 
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Seegle, LLC, 770 S. Woodruff Ave,
        ...
        <p>
          ...
          <p>
            We use a tool called “Google Analytics” to collect information about
            use of this site. Google Analytics collects information such as how
            often users visit this site, what pages they visit when they do so,
            and what other sites they used prior to coming to this site. We use
            the information we get from Google Analytics only to improve this
            site. Google Analytics collects only the IP address assigned to you
            ...
            visit this site, the cookie cannot be used by anyone but Google.
            ...
            <a href="http://www.google.com/analytics/tos.html">
        ...
        <p>
          We do not honor Do Not Track signals sent by some browsers. If you
          wish to avoid behavioral tracking by ad networks, please choose from
          appropriate settings available on Seegle or refrain from using Seegle.
        </p>
        ...
        <ul>
          <li>
            <p>
              By email:{" "}
              <a href="mailto:privacy@seegle.app">privacy@seegle.app</a>
            </p>
          </li>
          <li>
            <p>By mail: 770 S. Woodruff, Idaho Falls, ID 83401</p>
          </li>
        </ul>
""";

  Route _showPrivacy(BuildContext context) {
    void confirmed() {
      Get.back();
    }
  ...
  Widget build(BuildContext context) {
    return TextButton(
        ...
        onPressed: () {
          Navigator.of(context).push(_showPrivacy(context));
        });
  }
}

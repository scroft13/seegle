...
class Terms extends StatelessWidget {
  ...
  <p>
    ...
    of our app, Seegle, for Android and iOs (together or individually
    “Service”) operated by <b>Seegle, LLC</b>.
  </p>
  <p>
  ...
  <p>
    ...
    <b>support@seegle.app</b> so we can try to find a solution. These
  ...
  <p>
    Seegle, LLC has the right but not the obligation to monitor and edit
    all Content provided by users.
  </p>
  <p>
    In addition, Content found on or through this Service are the property
    of Seegle, LLC or used with permission. You may not distribute,
  ...
  <p>
    ...
    property of Seegle, LLC and its licensors. Service is protected by
    ...
    without the prior written consent of Seegle, LLC.
  </p>
  <p>
  ...
  <p>
    ...
    to support@seegle.app, with the subject line: “Copyright Infringement”
  ...
  <p>
    You can contact our Copyright Agent via email at support@seegle.com.
  </p>
  <p>
    12. <b>Error Reporting and Feedback</b>
  </p>
  <p>
    You may provide us either directly at support@seegle.app or via third
  ...
  <p>
    ...
    that are not owned or controlled by Seegle, LLC.
  </p>
  <p>
    Seegle, LLC has no control over, and assumes no responsibility for the
  ...
  <p>
    ...
    laws of Idaho, United States, which governing law applies to agreement
  ...
  <p>
    We may amend Terms at any time by posting the amended terms here. It
  ...
  <p>
    ...
    email: <b>support@seegle.app</b>.
  </p>
  """;
  Route _showTerms(BuildContext context) {
    void confirmed() {
      Get.back();
    }
  ...
  Widget build(BuildContext context) {
    return TextButton(
        ...
        onPressed: () {
          Navigator.of(context).push(_showTerms(context));
        });
  }
}
